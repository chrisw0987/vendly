...
function VendorInventoryTab() {
  ...
  useEffect(() => {
    if (!sellingItem) return undefined
  ...
  return (
    <div className="bg-black text-white">
      <main className="mx-auto max-w-[430px] px-5">
      ...
      {isVendor && sellingItem && (
        <div
          ...
          aria-modal="true"
        >
          <div className="flex h-[calc(100dvh-1.5rem)] max-h-[900px] w-full max-w-sm flex-col overflow-hidden rounded-3xl border border-[#222] bg-[#111] shadow-2xl sm:h-[calc(100dvh-2.5rem)]">
